...
| H — Admin progress dashboard | In progress (agent running) |
| H.1 — Student detail drill-down | Spec only, not started — do not implement until explicitly told to proceed |
| G — Final QA and handoff | Not started |
