...
(function () {
  ...
  const TENANT_TERMINOLOGY = [
    ...
    // Mission Next Labs tenant migration.
    [new RegExp(`\\b${TEMPORARY_TENANT}\\b`, 'g'), 'Mission Next Labs'],
    [/\bexample\.org\b/gi, 'missionnextlabs.example'],
    [/\bexample-org\b/gi, 'missionnextlabs'],
    [legacyTenantPattern('\\b{tenant}\\.onmicrosoft\\.com\\b'), 'missionnextlabs.example'],
    [legacyTenantPattern('\\b{tenant}\\.(?:com|example)\\b'), 'missionnextlabs.example'],
    [legacyTenantPattern('\\bDC={tenant},DC=com\\b'), 'DC=missionnextlabs,DC=example'],
    [legacyTenantPattern('\\b{tenant}(?=[\\\\/-])'), 'missionnextlabs'],
    [legacyTenantPattern('([\\\\/-]){tenant}\\b'), '$1missionnextlabs'],
    ...
    [legacyTenantPattern('\\b{tenant}\\b'), 'Mission Next Labs'],
    [legacyTenantPattern('{tenant}'), 'missionnextlabs'],
  ];
