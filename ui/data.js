...
const SEED_ALERTS = [
  ...
  { id:'A102', severity:'high', title:'Suspected DCSync attack (replication of directory services)',
    ...
    event:{ user:'svc-backup', source_ip:'10.20.4.55', target:'DC01.missionnextlabs.example' } },
  { id:'A201', severity:'high', title:'User compromised through phishing email with malicious URL',
    status:'New', category:'Initial access', detectionSource:'MDO', asset:'jane.doe@missionnextlabs.example',
  ...
  { id:'A202', severity:'medium', title:'Anomalous OAuth consent grant',
    status:'New', category:'Initial access', detectionSource:'MDA', asset:'jane.doe@missionnextlabs.example',
  ...
  { id:'A401', severity:'high', title:'Adversary-in-the-middle phishing session detected',
    status:'New', category:'Initial access', detectionSource:'Entra ID Protection', asset:'maria.ross@missionnextlabs.example',
    firstActivity:'2026-06-28T06:40:00Z', incidentId:'INC-1051',
    event:{ user:'maria.ross@missionnextlabs.example', source_ip:'185.199.111.12', sign_in_risk:'High', mfa_method:'Push' } },
  { id:'A501', severity:'high', title:'Container escaped to host namespace',
    ...
    event:{ cluster:'aks-prod', pod:'pod-api-77', image:'missionnextlabs/api:2026.06', syscall:'setns' } },
  { id:'A601', severity:'medium', title:'Risky sign-in from unfamiliar location',
    status:'New', category:'Credential access', detectionSource:'Entra ID Protection', asset:'sam.lee@missionnextlabs.example',
    firstActivity:'2026-06-28T13:27:00Z', incidentId:'INC-1053',
    event:{ user:'sam.lee@missionnextlabs.example', source_ip:'91.219.236.54', country:'NL', risk_level:'High' } },
  ...
  { id:'A901', severity:'low', title:'Password spray attempt blocked by identity protection',
    status:'New', category:'Credential access', detectionSource:'Entra ID Protection', asset:'liam.chen@missionnextlabs.example',
    firstActivity:'2026-06-28T16:34:00Z', incidentId:'INC-1060',
    event:{ user:'liam.chen@missionnextlabs.example', source_ip:'203.0.113.74', attempts:8,
  ...
  { id:'A1101', severity:'low', title:'External mailbox forwarding rule detected and disabled',
    status:'New', category:'Persistence', detectionSource:'MDO', asset:'nina.patel@missionnextlabs.example',
    firstActivity:'2026-06-28T17:02:00Z', incidentId:'INC-1062',
    event:{ user:'nina.patel@missionnextlabs.example', rule_name:'Forward invoices', destination:'archive-mail@external.example',
  ...
  { id:'A1301', severity:'informational', title:'Safe Links blocked a phishing URL before user access',
    status:'Resolved', category:'Initial access', detectionSource:'MDO', asset:'evan.brooks@missionnextlabs.example',
    firstActivity:'2026-06-28T17:31:00Z', incidentId:'INC-1064',
    event:{ user:'evan.brooks@missionnextlabs.example', subject:'Updated payroll calendar',
  ...
  { id:'A1401', severity:'informational', title:'Privileged role activation matched approved PIM request',
    status:'Resolved', category:'Privilege escalation', detectionSource:'Entra ID Protection', asset:'olivia.kim@missionnextlabs.example',
    firstActivity:'2026-06-28T17:44:00Z', incidentId:'INC-1065',
    event:{ user:'olivia.kim@missionnextlabs.example', role:'Security Administrator', duration:'45 minutes',
            approval:'CHG-4821 / approved' } },
  { id:'A1501', severity:'informational', title:'OAuth consent granted to verified publisher application',
    status:'New', category:'Persistence', detectionSource:'MDA', asset:'jordan.wong@missionnextlabs.example',
    firstActivity:'2026-06-28T17:56:00Z', incidentId:'INC-1066',
    event:{ user:'jordan.wong@missionnextlabs.example', app_name:'Mission Next Travel', publisher:'Verified',
...
const INCIDENTS = [
  ...
  { id:'INC-1042', severity:'high', title:'Phishing leading to OAuth consent abuse',
    ...
    entities:[{type:'User',name:'jane.doe@missionnextlabs.example'},{type:'URL',name:'secure-document-portal[.]xyz'},{type:'App',name:'DocViewer Pro'}],
  ...
  { id:'INC-1050', severity:'high', title:'Ransomware activity on finance file server',
    ...
    disruptionActions:[
      { time:'2026-06-28T10:18:36Z', action:'Contain user', target:'fin-svc@missionnextlabs.example',
  ...
  { id:'INC-1051', severity:'high', title:'AiTM phishing against finance user',
    ...
    entities:[{type:'User',name:'maria.ross@missionnextlabs.example'},{type:'IP',name:'185.199.111.12'},{type:'Session',name:'MFA proxied sign-in'}],
  ...
  { id:'INC-1053', severity:'medium', title:'AAD risky sign-in for sales user',
    ...
    entities:[{type:'User',name:'sam.lee@missionnextlabs.example'},{type:'IP',name:'91.219.236.54'}],
  ...
  { id:'INC-1055', severity:'high', title:'Suspicious PowerShell script execution on FIN-WKS-07',
    ...
    entities:[{type:'Device',name:'FIN-WKS-07'},{type:'User',name:'j.reyes@missionnextlabs.example'},{type:'File',name:'invoice_update.ps1'}],
  ...
  { id:'INC-1060', severity:'low', title:'Blocked password spray against single user',
    ...
    entities:[{type:'User',name:'liam.chen@missionnextlabs.example'},{type:'IP',name:'203.0.113.74'}],
  ...
  { id:'INC-1062', severity:'low', title:'Suspicious external mailbox forwarding rule',
    ...
    entities:[{type:'User',name:'nina.patel@missionnextlabs.example'},{type:'Mailbox rule',name:'Forward invoices'},{type:'Email',name:'archive-mail@external.example'}],
  ...
  { id:'INC-1064', severity:'informational', title:'Phishing URL blocked before user access',
    ...
    entities:[{type:'User',name:'evan.brooks@missionnextlabs.example'},{type:'URL',name:'payroll-calendar[.]example'}],
  ...
  { id:'INC-1065', severity:'informational', title:'Approved privileged role activation',
    ...
    entities:[{type:'User',name:'olivia.kim@missionnextlabs.example'},{type:'Role',name:'Security Administrator'},{type:'Change',name:'CHG-4821'}],
  ...
  { id:'INC-1066', severity:'informational', title:'Verified publisher OAuth consent review',
    ...
    entities:[{type:'User',name:'jordan.wong@missionnextlabs.example'},{type:'App',name:'Mission Next Travel'}],
...
const NOTIFICATION_RULES = [
  { name:'High severity incidents', trigger:'Incident created or updated', recipients:'soc-leads@missionnextlabs.example', filter:'Severity is High', status:'Enabled' },
  { name:'Pending action approvals', trigger:'Action center item pending', recipients:'endpoint-response@missionnextlabs.example', filter:'Action requires approval', status:'Enabled' },
  { name:'Threat analytics exposure', trigger:'Threat analytics report impacts assets', recipients:'threat-intel@missionnextlabs.example', filter:'Impacted assets > 0', status:'Enabled' },
];
...
const INCIDENT_EVIDENCE = {
  ...
  'INC-1042': [
    ...
    { type:'User',    name:'jane.doe@missionnextlabs.example',        verdict:'Suspicious', remediation:'Remediated',       action:'Sessions revoked' },
  ],
  'INC-1050': [
...
const BLAST_RADIUS_PATHS = {
  ...
  'INC-1042': {
    source:'jane.doe@missionnextlabs.example',
    paths:[
...
const ATTACK_STORIES = {
  ...
  'INC-1042': {
    nodes:[
      { id:'user-jane', type:'User', label:'jane.doe@missionnextlabs.example', ring:0,
  ...
  'INC-1051': {
    nodes:[
      { id:'maria', type:'User', label:'maria.ross@missionnextlabs.example', ring:0,
  ...
  'INC-1053': {
    nodes:[
      { id:'sam', type:'User', label:'sam.lee@missionnextlabs.example', ring:0,
...
const GUIDED_HUNTING_FILTERS = [
  ...
  { domain:'apps', section:'Identity logon events', table:'IdentityLogonEvents',
    ...
    values:['svc-backup@missionnextlabs.example','fin-svc@missionnextlabs.example','jane.doe@missionnextlabs.example'] },
  { domain:'apps', section:'Identity logon events', table:'IdentityLogonEvents',
    column:'Protocol', label:'Protocol', type:'string', basic:false,
    values:['Kerberos','NTLM'] },
  { domain:'apps', section:'Identity logon events', table:'IdentityLogonEvents',
  ...
  { domain:'apps', section:'Sign-in logs', table:'SigninLogs',
    ...
    values:['sam.lee@missionnextlabs.example','maria.ross@missionnextlabs.example'] },
  ...
  { domain:'cloud', section:'Container events', table:'ContainerEvents',
    column:'Image', label:'Image', type:'string', basic:true, values:['missionnextlabs/api:2026.06'] },
  { domain:'cloud', section:'Container events', table:'ContainerEvents',
...
const HUNTING_GRAPH_ENTITIES = [
  ...
  { id:'user-jane', type:'User', label:'jane.doe@missionnextlabs.example', risk:'high', riskScore:true, detail:'Finance analyst linked to the OAuth-consent investigation.' },
  { id:'user-jordan', type:'User', label:'jordan.wilber@missionnextlabs.example', risk:'low', detail:'Developer with inherited repository and storage access.' },
  { id:'user-helpdesk', type:'User', label:'lee.helpdesk@missionnextlabs.example', risk:'medium', vulnerable:true, riskScore:true, detail:'Helpdesk identity with password-reset delegation.' },
  { id:'user-tier0', type:'Sensitive identity', label:'admin.tier0@missionnextlabs.example', risk:'high', critical:true, sensitive:true, riskScore:true, detail:'Tier 0 administrator protected as a sensitive identity.' },
  { id:'user-asrep', type:'User', label:'legacy.batch@missionnextlabs.example', risk:'high', vulnerable:true, riskScore:true, detail:'Legacy account with Kerberos preauthentication disabled.' },
  { id:'user-hybrid', type:'Hybrid user', label:'svc.sync.owner@missionnextlabs.example', risk:'medium', critical:true, riskScore:true, detail:'Synced account that owns a privileged OAuth application.' },
  ...
  { id:'tenant-missionnextlabs', type:'Active Directory domain', label:'missionnextlabs.example', risk:'high', critical:true, sensitive:true, riskScore:true, detail:'Domain object whose replication rights enable DCSync.' },
...
const HUNTING_GRAPH_SCENARIOS = [
  ...
  { id:'domain-compromise', name:'Paths to domain compromise (DCSync)', question:'Which non-privileged identities have hidden paths to domain replication rights?', techniques:['Lateral movement','Privilege escalation','Credential access'], inputs:[],
    nodes:['user-jordan','group-helpdesk','user-helpdesk','tenant-missionnextlabs','server-dc01'],
    edges:[{from:'user-jordan',to:'group-helpdesk',label:'member of'},{from:'group-helpdesk',to:'user-helpdesk',label:'can impersonate as'},{from:'user-helpdesk',to:'tenant-missionnextlabs',label:'has permissions to'},{from:'tenant-missionnextlabs',to:'server-dc01',label:'contains'}] },
...
const KQL_PRACTICE_ROWS = [
  { TimeGenerated:'2026-07-06T09:10:00Z', Scenario:'endpoint staging',
    Message:'user=jane.doe@missionnextlabs.example ip=76.21.55.4 action=allow', Payload:'{"user":"jane.doe@missionnextlabs.example","device":"WKS-03","risk":"High"}', Tags:'finance|priority|cloud',
    Domain:'secure-document-portal.xyz', Source:'DeviceProcessEvents' },
  { TimeGenerated:'2026-07-06T10:12:00Z', Scenario:'identity pivot',
    Message:'user=sam.lee@missionnextlabs.example ip=91.219.236.54 action=block', Payload:'{"user":"sam.lee@missionnextlabs.example","device":"WKS-11","risk":"Medium"}', Tags:'identity|risk|mfa',
    Domain:'login.missionnextlabs.example', Source:'SigninLogs' },
  { TimeGenerated:'2026-07-06T10:14:00Z', Scenario:'cloud app follow-up',
    Message:'user=maria.ross@missionnextlabs.example ip=185.199.111.12 action=alert', Payload:'{"user":"maria.ross@missionnextlabs.example","device":"LAP-07","risk":"High"}', Tags:'cloud|oauth|mail',
...
| where DnsQuery has_any ("sync-a.bad-demo.example","cdn-metrics.missionnextlabs.example")
...
| project TimeGenerated, DnsQuery, QueryCount, UniqueHosts`,
  results:[
    ...
    { TimeGenerated:'2026-06-21T00:00:00Z', DnsQuery:'cdn-metrics.missionnextlabs.example', QueryCount:411, UniqueHosts:1, SourceTable:'ArchiveDns_CL', RestoreJobId:'RST-8401' },
  ],
};
...
const ARCHIVE_DNS_AUX_ROWS = [
  ...
  { TimeGenerated:'2026-06-21T00:00:00Z', DnsQuery:'cdn-metrics.missionnextlabs.example', QueryCount:411, UniqueHosts:1, Tier:'Auxiliary', SourceTable:'ArchiveDns_CL' },
];
...
const MOCK_QUERY_RESULTS = {
  ...
  GraphActivityLogs: [
    { TimeGenerated:'2026-06-28T08:31:00Z', UserPrincipalName:'jane.doe@missionnextlabs.example',
      AppDisplayName:'DocViewer Pro', AppId:'b9f2-demo-ad21', Operation:'Mail.Read',
      RequestUri:'/users/jane.doe@missionnextlabs.example/messages', IPAddress:'76.21.55.4', ResultStatus:'Success' },
    { TimeGenerated:'2026-06-28T08:33:12Z', UserPrincipalName:'jane.doe@missionnextlabs.example',
      AppDisplayName:'DocViewer Pro', AppId:'b9f2-demo-ad21', Operation:'Files.Read.All',
      RequestUri:'/users/jane.doe@missionnextlabs.example/drive/root/search(q=invoice)', IPAddress:'76.21.55.4', ResultStatus:'Success' },
    { TimeGenerated:'2026-06-28T08:36:44Z', UserPrincipalName:'jane.doe@missionnextlabs.example',
      AppDisplayName:'DocViewer Pro', AppId:'b9f2-demo-ad21', Operation:'Mail.Send',
      RequestUri:'/users/jane.doe@missionnextlabs.example/sendMail', IPAddress:'76.21.55.4', ResultStatus:'Denied' },
    { TimeGenerated:'2026-06-28T13:34:09Z', UserPrincipalName:'sam.lee@missionnextlabs.example',
  ...
  DeviceLogonEvents: [
    { Timestamp:'2026-07-06T03:44:05Z', DeviceName:'FIN-FS-02', ActionType:'LogonSuccess',
      LogonType:'Network', AccountName:'svc-backup', AccountDomain:'MISSIONNEXTLABS',
    ...
    { Timestamp:'2026-07-06T10:17:55Z', DeviceName:'FIN-FS-02', ActionType:'LogonSuccess',
      LogonType:'RemoteInteractive', AccountName:'fin-svc', AccountDomain:'MISSIONNEXTLABS',
    ...
    { Timestamp:'2026-07-06T14:59:48Z', DeviceName:'WKS-03', ActionType:'LogonFailed',
      LogonType:'Interactive', AccountName:'jdoe', AccountDomain:'MISSIONNEXTLABS',
  ...
  IdentityLogonEvents: [
    { Timestamp:'2026-07-06T03:44:00Z', ActionType:'LogonSuccess', Application:'Active Directory',
      ...
      AccountName:'svc-backup', AccountDomain:'MISSIONNEXTLABS',
      AccountUpn:'svc-backup@missionnextlabs.example',
      AccountSid:'S-1-5-21-1180699209-877415012-3182924384-1144',
    ...
    { Timestamp:'2026-07-06T10:17:58Z', ActionType:'LogonSuccess', Application:'Active Directory',
      ...
      AccountName:'fin-svc', AccountDomain:'MISSIONNEXTLABS',
      AccountUpn:'fin-svc@missionnextlabs.example',
      AccountSid:'S-1-5-21-1180699209-877415012-3182924384-2207',
    ...
    { Timestamp:'2026-07-06T14:59:55Z', ActionType:'LogonFailed', Application:'Active Directory',
      ...
      AccountName:'jdoe', AccountDomain:'MISSIONNEXTLABS',
      AccountUpn:'jane.doe@missionnextlabs.example',
      AccountSid:'S-1-5-21-1180699209-877415012-3182924384-1812',
      AccountObjectId:'7f2b1e90-5c10-4ad9-b3e3-44ea7c8b1cf3',
      DeviceName:'WKS-03', IPAddress:'10.20.7.42' },
  ],
  SigninLogs: [
    { TimeGenerated:'2026-06-28T13:27:00Z', UserPrincipalName:'sam.lee@missionnextlabs.example',
      IPAddress:'91.219.236.54', RiskLevel:'High', ResultType:'0' },
    { TimeGenerated:'2026-06-28T06:40:00Z', UserPrincipalName:'maria.ross@missionnextlabs.example',
  ...
  ContainerEvents: [
    { TimeGenerated:'2026-06-28T12:01:00Z', ClusterName:'aks-prod', PodName:'pod-api-77',
      Image:'missionnextlabs/api:2026.06', Syscall:'setns', NodeName:'aks-prod/node-3' },
  ],
  SecurityEvent: [
  ...
  CommonSecurityLog: [
    { TimeGenerated:'2026-07-06T08:20:00Z', DeviceVendor:'Mission Next Labs Firewall', DeviceProduct:'EdgeFW',
    ...
    { TimeGenerated:'2026-07-06T08:22:15Z', DeviceVendor:'Mission Next Labs Firewall', DeviceProduct:'EdgeFW',
  ...
  AzureActivity: [
    { TimeGenerated:'2026-07-06T07:50:00Z', SubscriptionId:'sub-prod-001',
      Caller:'cloudadmin@missionnextlabs.example', OperationNameValue:'Cloud.Authorization/roleAssignments/write',
    ...
    { TimeGenerated:'2026-07-06T07:57:31Z', SubscriptionId:'sub-shared-002',
      Caller:'platformops@missionnextlabs.example', OperationNameValue:'Cloud.Authorization/policyAssignments/write',
    ...
    { TimeGenerated:'2026-07-06T08:05:44Z', SubscriptionId:'sub-prod-001',
      Caller:'storage-owner@missionnextlabs.example', OperationNameValue:'Cloud.Storage/storageAccounts/write',
  ...
  AppRiskEvents_CL: [
    { TimeGenerated:'2026-07-06T08:31:00Z', AppId:'app-expense-portal',
      UserPrincipalName:'maria.ross@missionnextlabs.example', SourceIp:'203.0.113.44', RiskScore:92, Action:'BlockedOAuthCallback' },
    { TimeGenerated:'2026-07-06T08:34:18Z', AppId:'app-partner-sync',
      UserPrincipalName:'svc-partner@missionnextlabs.example', SourceIp:'198.51.100.64', RiskScore:35, Action:'AllowedSync' },
    { TimeGenerated:'2026-07-06T08:39:02Z', AppId:'app-expense-portal',
      UserPrincipalName:'sam.lee@missionnextlabs.example', SourceIp:'203.0.113.89', RiskScore:78, Action:'HighRiskTokenUse' },
  ],
...
login.missionnextlabs.example,auth,2
bad-demo.example,phish,1
update.example,benign,3`;

const ASIM_AUTHENTICATION_ROWS = [
  { TimeGenerated:'2026-07-06T03:44:00Z', EventVendor:'Mission Next Labs', EventProduct:'Windows', EventSchema:'Authentication', EventType:'Logon', EventResult:'Success',
  ...
  { TimeGenerated:'2026-07-06T10:17:58Z', EventVendor:'Mission Next Labs', EventProduct:'Entra ID', EventSchema:'Authentication', EventType:'Logon', EventResult:'Success',
    SrcIpAddr:'91.219.236.54', DstIpAddr:'52.96.0.0', SrcHostname:'unknown', DstHostname:'login.identity.example', TargetUserName:'sam.lee@missionnextlabs.example', DvcAction:'MFA satisfied', Dvc:'AAD' },
  { TimeGenerated:'2026-07-06T13:27:00Z', EventVendor:'Mission Next Labs', EventProduct:'Entra ID', EventSchema:'Authentication', EventType:'Logon', EventResult:'Failure',
    SrcIpAddr:'91.219.236.54', DstIpAddr:'52.96.0.0', SrcHostname:'proxy-91-219-236-54', DstHostname:'login.identity.example', TargetUserName:'sam.lee@missionnextlabs.example', DvcAction:'Risky sign-in', Dvc:'AAD' },
  { TimeGenerated:'2026-07-06T06:40:00Z', EventVendor:'Mission Next Labs', EventProduct:'Entra ID', EventSchema:'Authentication', EventType:'Logon', EventResult:'Success',
    SrcIpAddr:'185.199.111.12', DstIpAddr:'52.96.0.0', SrcHostname:'aitm-gateway', DstHostname:'login.identity.example', TargetUserName:'maria.ross@missionnextlabs.example', DvcAction:'MFA proxied', Dvc:'AAD' },
];
...
| where TargetUserName in ("sam.lee@missionnextlabs.example","maria.ross@missionnextlabs.example")
...
const ASIM_NETWORK_SESSION_ROWS = [
  { TimeGenerated:'2026-07-06T08:20:00Z', EventVendor:'Mission Next Labs Firewall', EventProduct:'EdgeFW', EventSchema:'NetworkSession', EventType:'NetworkSession', EventResult:'Allowed',
  ...
  { TimeGenerated:'2026-07-06T08:22:15Z', EventVendor:'Mission Next Labs Firewall', EventProduct:'EdgeFW', EventSchema:'NetworkSession', EventType:'NetworkSession', EventResult:'Allowed',
  ...
  { TimeGenerated:'2026-07-06T08:23:44Z', EventVendor:'Mission Next Labs Firewall', EventProduct:'EdgeFW', EventSchema:'NetworkSession', EventType:'NetworkSession', EventResult:'Blocked',
...
const CLOUD_APP_INVESTIGATIONS = [
  { id:'MDA-OAUTH-1042', incidentId:'INC-1042', status:'Active investigation',
    appName:'DocViewer Pro', publisher:'Unverified publisher', user:'jane.doe@missionnextlabs.example',
...
const ENTRA_IDENTITY_INVESTIGATIONS = [
  { id:'IDRISK-1053', incidentId:'INC-1053', user:'sam.lee@missionnextlabs.example',
  ...
  { id:'IDRISK-1051', incidentId:'INC-1051', user:'maria.ross@missionnextlabs.example',
...
const COPILOT_AGENTIC_FLOW = {
  ...
  toolCalls:[
    ...
    { tool:'expand_entities', input:'jane.doe@missionnextlabs.example', output:'Linked URL secure-document-portal[.]xyz, app DocViewer Pro, IP 76.21.55.4, mailbox Jane Doe mailbox.' },
    ...
    { tool:'query_signin_logs', input:'UserPrincipalName == "jane.doe@missionnextlabs.example"', output:'Successful MFA-backed sign-in from unfamiliar IP immediately after URL click.' },
  ],
...
const SENTINEL_CONTENT_SOLUTIONS = [
  { id:'syslog', name:'Syslog', provider:'Mission Next Labs', status:'Not installed',
    connectors:['Syslog via AMA'],
    use:'Adds the Syslog via AMA connector and workbook content for Linux Syslog ingestion.' },
  { id:'cef', name:'Common Event Format (CEF)', provider:'Mission Next Labs', status:'Not installed',
    connectors:['Common Event Format via AMA'],
    use:'Adds the CEF via AMA connector for appliances that emit CEF-formatted Syslog.' },
  { id:'threat-intel', name:'Threat Intelligence', provider:'Mission Next Labs', status:'Installed',
  ...
  { id:'windows-security', name:'Windows Security Events', provider:'Mission Next Labs', status:'Installed',
    connectors:['Windows Security Events via AMA'],
    use:'Adds Windows event collection with Azure Monitor Agent and DCR scoping.' },
  { id:'azure-activity', name:'Azure Activity', provider:'Mission Next Labs', status:'Installed',
...
| order by Events desc`,
  },
  {
    ...
    target:'Subscriptions: Mission-Next-Labs-Prod, Mission-Next-Labs-Shared',
    table:'AzureActivity',
...
const SYNTHETIC_TRANSACTIONS = [
  { TimeGenerated:'2026-06-28T13:40:00Z', SrcIp:'10.0.0.5', DstIp:'203.0.113.10',
    ...
    AccountName:'labuser@missionnextlabs.example', Action:'OutboundConnection',
  ...
  { TimeGenerated:'2026-06-28T13:46:00Z', SrcIp:'10.0.0.8', DstIp:'198.51.100.22',
    ...
    AccountName:'svc-agent@missionnextlabs.example', Action:'OutboundConnection',
  ...
  { TimeGenerated:'2026-06-28T14:04:00Z', SrcIp:'10.0.0.9', DstIp:'192.0.2.44',
    ...
    AccountName:'jane.doe@missionnextlabs.example', Action:'DnsRequest',
...
const CLOUD_ALERTS = [
  ...
  { id:'dfc-alert-03', severity:'medium', title:'Anonymous public read access enabled on a storage account', resource:'stmissionnextlabslogs',
    ...
    entities:[
      { type:'Storage account', value:'stmissionnextlabslogs' },
      { type:'IP address',      value:'203.0.113.44' },
      { type:'Account',         value:'svc-deploy' },
    ],
  ...
  { id:'dfc-alert-05', severity:'medium', title:'SQL server firewall rule opened to the entire internet', resource:'sql-prod-reporting',
    ...
    entities:[
      ...
      { type:'Account',    value:'dba-oncall@missionnextlabs.example' },
  ...
  { id:'dfc-alert-07', severity:'medium', title:'Owner role assigned at subscription scope outside of change control', resource:'sub-prod-001',
    ...
    entities:[
      ...
      { type:'Account',      value:'platform-admin@missionnextlabs.example' },
      { type:'Role',         value:'Owner' },
    ],
    evidence:{ 'Principal type':'User', 'Assigned by':'break-glass-01@missionnextlabs.example', 'Change record':'Filed retroactively', 'Duration':'Permanent' },
    mitigation:[
  ...
  { id:'dfc-alert-09', severity:'medium', title:'App Service built-in authentication turned off', resource:'app-customer-portal',
    ...
    entities:[
      ...
      { type:'Account',     value:'appdev-lead@missionnextlabs.example' },
    ],
...
| project TimeGenerated, UserPrincipalName, IPAddress, RiskLevel, ResultType`,
    ...
    row:{
      ...
      UserPrincipalName:'sam.lee@missionnextlabs.example',
...
| project TimeGenerated, DnsQuery, QueryCount, UniqueHosts`,
  results:[
    ...
    { TimeGenerated:'2026-06-21T00:00:00Z', DnsQuery:'cdn-metrics.missionnextlabs.example', QueryCount:411, UniqueHosts:1, Verdict:'Benign updater allowlist review' },
  ],
};
...
const SENTINEL_ANOMALY_HUNTING_ROWS = [
  { TimeGenerated:'2026-07-06T07:42:00Z', AnomalyRule:'Anomalous sign-in location by user', Entity:'sam.lee@missionnextlabs.example', Score:'0.91', RelatedTable:'SigninLogs', Action:'Open identity investigation' },
  ...
  { TimeGenerated:'2026-07-06T08:23:00Z', AnomalyRule:'Impossible travel with OAuth grant', Entity:'jane.doe@missionnextlabs.example', Score:'0.96', RelatedTable:'CloudAppEvents', Action:'Create high severity incident' },
];
...
const DEFENDER_CLOUD_RECS = [
  ...
  { id:'R-002', severity:'high', title:'Storage accounts should disable public network access',
    ...
    assets:['stmissionnextlabslogs','stprodcustomer','stfinancearchive','stbuildartifacts'], initiatives:['Cloud security benchmark','PCI DSS 4.0'],
...
const CLOUD_ASSETS = [
  ...
  { id:'azure-stmissionnextlabslogs', name:'stmissionnextlabslogs', type:'Storage account', subscription:'sub-prod-001', region:'westeurope',
    resourceId:'/subscriptions/sub-prod-001/resourceGroups/rg-prod-data/providers/Cloud.Storage/storageAccounts/stmissionnextlabslogs',
    risk:'Medium', exposure:'Public network access', alerts:1, recs:2,
    alertResources:['stmissionnextlabslogs'] },
...
const DLP_INCIDENTS = [
  { id:'DLP-1007', severity:'high', status:'Needs review', policy:'U.S. Financial Data',
    user:'jdoe@missionnextlabs.example', location:'OneDrive', item:'customer-list.xlsx',
  ...
  { id:'DLP-1012', severity:'medium', status:'User override requested', policy:'PII protection (U.S.)',
    user:'maria.ross@missionnextlabs.example', location:'SharePoint', item:'employee-roster.csv',
...
const INSIDER_RISK_CASES = [
  { id:'IR-2044', priority:'High', status:'Active', user:'olivia.martin@missionnextlabs.example',
  ...
  { id:'IR-2051', priority:'Medium', status:'Needs triage', user:'jdoe@missionnextlabs.example',
...
const COMMUNICATION_REVIEWS = [
  { id:'CC-3301', policy:'Regulated financial communications', severity:'medium',
    user:'trader1@missionnextlabs.example', channel:'Teams', status:'Pending reviewer',
  ...
  { id:'CC-3308', policy:'Code of conduct', severity:'low',
    user:'sales.rep@missionnextlabs.example', channel:'Exchange', status:'Resolved',
...
const EDISCOVERY_CASES = [
  { id:'ED-9004', name:'Departing user data leak review', status:'Active',
    custodians:['olivia.martin@missionnextlabs.example'], sources:['Exchange mailbox','OneDrive','Teams chats'],
  ...
  { id:'ED-9011', name:'OAuth consent abuse legal hold', status:'Draft',
    custodians:['jane.doe@missionnextlabs.example'], sources:['Exchange mailbox','Audit logs'],
...
const EDISCOVERY_CONTENT_SEARCH = {
  ...
  preview:[
    { location:'Exchange mailbox', item:'Action required: invoice overdue', custodian:'jane.doe@missionnextlabs.example',
      date:'2026-06-28T08:09:00Z', kind:'Email', match:'secure-document-portal[.]xyz link in message body' },
    { location:'Exchange mailbox', item:'DocViewer Pro permissions granted', custodian:'jane.doe@missionnextlabs.example',
      date:'2026-06-28T08:24:00Z', kind:'Notification', match:'OAuth app consent notification' },
    { location:'OneDrive', item:'Invoice-June-Overdue.url', custodian:'jane.doe@missionnextlabs.example',
...
const LABEL_ACTIVITY = [
  { time:'2026-06-28T13:12:00Z', user:'maria.ross@missionnextlabs.example', file:'Q4-forecast.xlsx', label:'Confidential\\Engineering', action:'Applied automatically' },
  { time:'2026-06-28T12:43:00Z', user:'legal.ops@missionnextlabs.example', file:'Litigation-hold.docx', label:'Highly confidential\\Legal', action:'Applied manually' },
  { time:'2026-06-28T11:58:00Z', user:'jdoe@missionnextlabs.example', file:'customer-list.xlsx', label:'General', action:'Downgraded with justification' },
];
...
const COPILOT_PROMPTS = [
  ...
  { title:'Expand Jane Doe entities',
    answer:'Pivot from jane.doe@missionnextlabs.example to the phishing URL, OAuth app DocViewer Pro, sign-in IP 76.21.55.4, and recent CloudAppEvents consent activity.',
    sessionId:'cs-003' },
...
const IM_DNS = [
  ...
  { TimeGenerated:'2026-06-29T07:55:01Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
  ...
  { TimeGenerated:'2026-06-29T07:55:14Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T07:56:02Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T07:58:30Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T08:00:00Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T08:02:01Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
  ...
  { TimeGenerated:'2026-06-29T08:02:04Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Failure', EventResultDetails:'NXDOMAIN',
    SrcIpAddr:'10.0.4.77', SrcHostname:'WKS-FIN-03', DstIpAddr:'10.0.0.10', DnsQuery:'jq8z7nx-rmav.top',
    DnsQueryTypeName:'A', DnsResponseName:'' },
  { TimeGenerated:'2026-06-29T08:02:07Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Failure', EventResultDetails:'NXDOMAIN',
    SrcIpAddr:'10.0.4.77', SrcHostname:'WKS-FIN-03', DstIpAddr:'10.0.0.10', DnsQuery:'lzpq3rk-x4mq.top',
    DnsQueryTypeName:'A', DnsResponseName:'' },
  { TimeGenerated:'2026-06-29T08:02:09Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Failure', EventResultDetails:'NXDOMAIN',
    SrcIpAddr:'10.0.4.77', SrcHostname:'WKS-FIN-03', DstIpAddr:'10.0.0.10', DnsQuery:'pq3rkmz-9xq2.top',
    DnsQueryTypeName:'A', DnsResponseName:'' },
  { TimeGenerated:'2026-06-29T08:02:12Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Failure', EventResultDetails:'NXDOMAIN',
    SrcIpAddr:'10.0.4.77', SrcHostname:'WKS-FIN-03', DstIpAddr:'10.0.0.10', DnsQuery:'rkmz9xq2-pq3l.top',
    DnsQueryTypeName:'A', DnsResponseName:'' },
  { TimeGenerated:'2026-06-29T08:02:15Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Failure', EventResultDetails:'NXDOMAIN',
  ...
  { TimeGenerated:'2026-06-29T08:05:20Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T08:05:25Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T08:08:14Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T08:08:20Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
  ...
  { TimeGenerated:'2026-06-29T08:13:01Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
    SrcIpAddr:'198.51.100.22', SrcHostname:'(external)', DstIpAddr:'10.0.0.10', DnsQuery:'missionnextlabs.example',
    DnsQueryTypeName:'ANY', DnsResponseName:'(multiple)' },
  { TimeGenerated:'2026-06-29T08:13:09Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
    SrcIpAddr:'203.0.113.41', SrcHostname:'(external)', DstIpAddr:'10.0.0.10', DnsQuery:'missionnextlabs.example',
    DnsQueryTypeName:'ANY', DnsResponseName:'(multiple)' },

  // Plain NXDOMAIN typos — noise that any NXDOMAIN-only rule will surface.
  { TimeGenerated:'2026-06-29T08:14:22Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Failure', EventResultDetails:'NXDOMAIN',
    SrcIpAddr:'10.0.4.12', SrcHostname:'WKS-01', DstIpAddr:'10.0.0.10', DnsQuery:'microsft.com',
    DnsQueryTypeName:'A', DnsResponseName:'' },
  { TimeGenerated:'2026-06-29T08:14:48Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Failure', EventResultDetails:'NXDOMAIN',
  ...
  { TimeGenerated:'2026-06-29T08:16:10Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
    SrcIpAddr:'10.0.0.5', SrcHostname:'MAIL-01', DstIpAddr:'10.0.0.10', DnsQuery:'corp.missionnextlabs.example',
    DnsQueryTypeName:'MX', DnsResponseName:'mail-01.corp.missionnextlabs.example' },
  { TimeGenerated:'2026-06-29T08:16:42Z', EventProduct:'Mission Next Labs DNS Server', EventVendor:'Mission Next Labs', EventSchema:'Dns',
    EventType:'Query', EventSubType:'response', EventResult:'Success', EventResultDetails:'NoError',
    SrcIpAddr:'10.0.0.5', SrcHostname:'MAIL-01', DstIpAddr:'10.0.0.10', DnsQuery:'_dmarc.missionnextlabs.example',
    DnsQueryTypeName:'TXT', DnsResponseName:'"v=DMARC1; p=reject; rua=mailto:dmarc@missionnextlabs.example"' },
];
...
const ASIM_DNS_NOTES = [
  { title:'Unifying parser', detail:'_Im_Dns calls every source-specific parser (vimDnsMissionNextLabsOMS, vimDnsCorelightZeek, …) and returns a single normalized result set. Always prefer it over a raw table name.' },
...
const DEVICES = [
  { avStatus:'Up to date', excluded:false, winVersion:'—', id:'WKS-03', name:'WKS-03', domain:'missionnextlabs.example', os:'Windows 11 Enterprise 23H2',
    ...
    primaryUser:'jdoe@missionnextlabs.example', ip:'10.20.7.42', tags:['Sales','Win11'], openAlerts:2,
    isInternetFacing:true, recommendationCount:3, installedSoftware:42, discoveredVulnerabilities:2 },
  { avStatus:'Up to date', excluded:false, winVersion:'—', id:'FIN-FS-02', name:'FIN-FS-02', domain:'missionnextlabs.example', os:'Windows Server 2022',
    ...
    primaryUser:'fin-svc@missionnextlabs.example', ip:'10.20.3.14', tags:['Finance','FileServer'], openAlerts:2,
    isInternetFacing:false, recommendationCount:5, installedSoftware:64, discoveredVulnerabilities:4 },
  { avStatus:'Up to date', excluded:false, winVersion:'—', id:'WKS-01', name:'WKS-01', domain:'missionnextlabs.example', os:'Windows 11 Enterprise 23H2',
    ...
    primaryUser:'svc-scan@missionnextlabs.example', ip:'10.20.7.10', tags:['IT','Win11'], openAlerts:1,
    isInternetFacing:false, recommendationCount:2, installedSoftware:39, discoveredVulnerabilities:1 },
  { avStatus:'Not updated', excluded:false, winVersion:'—', id:'WKS-02', name:'WKS-02', domain:'missionnextlabs.example', os:'Windows 11 Enterprise 23H2',
    ...
    primaryUser:'svc-scan@missionnextlabs.example', ip:'10.20.7.11', tags:['IT','Win11'], openAlerts:1,
    isInternetFacing:false, recommendationCount:1, installedSoftware:37, discoveredVulnerabilities:1 },
  { avStatus:'Up to date', excluded:true, winVersion:'—', id:'DC01', name:'DC01', domain:'missionnextlabs.example', os:'Windows Server 2022 (Domain Controller)',
  ...
  { avStatus:'Up to date', excluded:false, winVersion:'22H2',
    id:'W10-SALES-11', name:'W10-SALES-11', domain:'missionnextlabs.example', os:'Windows 10 Enterprise 22H2',
    ...
    primaryUser:'mrivera@missionnextlabs.example', ip:'10.20.7.51', tags:['Sales','Win10'], openAlerts:0,
  ...
  { avStatus:'Not updated', excluded:false, winVersion:'21H2',
    id:'W10-SALES-12', name:'W10-SALES-12', domain:'missionnextlabs.example', os:'Windows 10 Enterprise 21H2',
    ...
    primaryUser:'tchen@missionnextlabs.example', ip:'10.20.7.52', tags:['Sales','Win10'], openAlerts:0,
  ...
  { avStatus:'Disabled', excluded:false, winVersion:'21H1',
    id:'W10-ENG-04', name:'W10-ENG-04', domain:'missionnextlabs.example', os:'Windows 10 Pro 21H1',
    ...
    primaryUser:'dpatel@missionnextlabs.example', ip:'10.20.8.14', tags:['Engineering','Win10'], openAlerts:1,
  ...
  { avStatus:'Unknown', excluded:false, winVersion:'20H2',
    id:'W10-ENG-05', name:'W10-ENG-05', domain:'missionnextlabs.example', os:'Windows 10 Pro 20H2',
    ...
    primaryUser:'dpatel@missionnextlabs.example', ip:'10.20.8.15', tags:['Engineering','Win10'], openAlerts:0,
  ...
  { avStatus:'Unknown', excluded:false, winVersion:'2004',
    id:'W10-LAB-02', name:'W10-LAB-02', domain:'missionnextlabs.example', os:'Windows 10 Enterprise 2004',
    ...
    primaryUser:'svc-lab@missionnextlabs.example', ip:'10.20.11.22', tags:['Lab','Win10'], openAlerts:0,
  ...
  { avStatus:'Not updated', excluded:true, winVersion:'1909',
    id:'W10-KIOSK-01', name:'W10-KIOSK-01', domain:'missionnextlabs.example', os:'Windows 10 Enterprise LTSC 1909',
    riskLevel:'Medium', exposureLevel:'Medium', healthStatus:'Active', onboardingStatus:'Onboarded',
  ...
  { avStatus:'Disabled', excluded:true, winVersion:'1903',
    id:'W10-OT-BRIDGE', name:'W10-OT-BRIDGE', domain:'missionnextlabs.example', os:'Windows 10 IoT Enterprise 1903',
    riskLevel:'High', exposureLevel:'High', healthStatus:'Misconfigured', onboardingStatus:'Onboarded',
  ...
  { avStatus:'Unknown', excluded:false, winVersion:'1809',
    id:'W10-LEGACY-07', name:'W10-LEGACY-07', domain:'missionnextlabs.example', os:'Windows 10 Enterprise LTSC 1809',
    ...
    primaryUser:'mfoster@missionnextlabs.example', ip:'10.20.11.31', tags:['Legacy','Win10'], openAlerts:0,
  ...
  { avStatus:'Disabled', excluded:false, winVersion:'1803',
    id:'W10-LEGACY-08', name:'W10-LEGACY-08', domain:'missionnextlabs.example', os:'Windows 10 Pro 1803',
    riskLevel:'High', exposureLevel:'High', healthStatus:'Misconfigured', onboardingStatus:'Onboarded',
    sensor:'Defender for Endpoint', firstSeen:'2022-08-05T08:04:00Z', lastSeen:'2026-06-27T21:30:00Z',
    primaryUser:'mfoster@missionnextlabs.example', ip:'10.20.11.32', tags:['Legacy','Win10'], openAlerts:1,
  ...
  { avStatus:'Unknown', excluded:false, winVersion:'1709',
    id:'W10-LEGACY-09', name:'W10-LEGACY-09', domain:'missionnextlabs.example', os:'Windows 10 Pro 1709',
    riskLevel:'High', exposureLevel:'Medium', healthStatus:'Inactive', onboardingStatus:'Onboarded',
  ...
  { avStatus:'Unknown', excluded:false, winVersion:'1703',
    id:'W10-LEGACY-10', name:'W10-LEGACY-10', domain:'missionnextlabs.example', os:'Windows 10 Pro 1703',
    riskLevel:'High', exposureLevel:'Medium', healthStatus:'Inactive', onboardingStatus:'Onboarded',
  ...
  { avStatus:'Disabled', excluded:false, winVersion:'1607',
    id:'W10-LEGACY-11', name:'W10-LEGACY-11', domain:'missionnextlabs.example', os:'Windows 10 Enterprise LTSB 1607',
  ...
  { avStatus:'Up to date', excluded:false, winVersion:'Future',
    id:'W10-INSIDER-01', name:'W10-INSIDER-01', domain:'missionnextlabs.example', os:'Windows 10 Enterprise Insider Preview',
    riskLevel:'Low', exposureLevel:'Low', healthStatus:'Active', onboardingStatus:'Onboarded',
    sensor:'Defender for Endpoint', firstSeen:'2026-05-20T08:00:00Z', lastSeen:'2026-06-28T14:50:00Z',
    primaryUser:'itlab@missionnextlabs.example', ip:'10.20.11.40', tags:['IT','Insider'], openAlerts:0,
...
const DISCOVERED_DEVICES = [
  ...
  { id:'DD-001', name:'LAB-VM-07', tab:'computers', type:'Workstation', os:'Windows 10 Pro 22H2',
    ip:'10.20.7.88', mac:'00-15-5D-3A-11-04', vendor:'Mission Next Labs', network:'CORP-LAN',
...
const FLEET_OUI = {
  ...
  'Mission Next Labs':'00-15-5D', 'VMware, Inc.':'00-50-56', 'QEMU/KVM':'52-54-00',
...
const FLEET_CATALOG = [
  ...
  { t:'Virtual machine', tab:'computers', p:'VM', sub:'10.20.3', n:{lan:16},
    v:['VMware, Inc.','QEMU/KVM','Mission Next Labs'], os:['Ubuntu Server 22.04 LTS','Windows Server 2019','Debian 12'],
  ...
  { t:'Tablet', tab:'computers', p:'TAB', sub:'10.20.9', n:{wifi:10},
    v:['Apple, Inc.','Samsung Electronics','Mission Next Labs'], os:['iPadOS 17.5','Android 14','Windows 11 Pro 23H2'],
  ...
  { t:'Interactive whiteboard', tab:'iot', p:'IWB', sub:'10.20.5', n:{lan:3},
    v:['Mission Next Labs','Samsung Electronics'], os:['Windows 10 Team 2022','Tizen 7.0 (Flip)'],
  ...
  { t:'Game console', tab:'iot', p:'CONSOLE', sub:'10.20.9', n:{wifi:2},
    v:['Sony Corporation','Mission Next Labs'], os:['PlayStation 5 firmware 24.06','Xbox OS 10.0'],
...
const DEVICE_TIMELINE_EVENTS = {
  ...
  'DC01': [
    ...
    { kind:'event', time:'2026-06-28T03:44:00Z', table:'DeviceEvents', actionType:'DirectoryServicesReplication',
      ...
      account:'svc-backup', target:'DC01.missionnextlabs.example', techniqueId:'T1003', eventType:'Directory' },
...
const IDENTITIES = [
  { id:'jane.doe@missionnextlabs.example', displayName:'Jane Doe', samName:'jane.doe',
    upn:'jane.doe@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-1102',
  ...
  { id:'svc-backup@missionnextlabs.example', displayName:'svc-backup', samName:'svc-backup',
    upn:'svc-backup@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-1144',
  ...
  { id:'MSOL_AzureSync@missionnextlabs.example', displayName:'MSOL_AzureSync', samName:'MSOL_AzureSync',
    upn:'MSOL_AzureSync@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-1206',
  ...
  { id:'sam.lee@missionnextlabs.example', displayName:'Sam Lee', samName:'sam.lee',
    upn:'sam.lee@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-1203',
  ...
  { id:'maria.ross@missionnextlabs.example', displayName:'Maria Ross', samName:'maria.ross',
    upn:'maria.ross@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-1208',
  ...
  { id:'jdoe@missionnextlabs.example', displayName:'jdoe (local)', samName:'jdoe',
    upn:'jdoe@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-1812',
  ...
  { id:'fin-svc@missionnextlabs.example', displayName:'fin-svc', samName:'fin-svc',
    upn:'fin-svc@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-2207',
  ...
  { id:'krbtgt@missionnextlabs.example', displayName:'krbtgt', samName:'krbtgt',
    upn:'krbtgt@missionnextlabs.example', sid:'S-1-5-21-1180699209-877415012-3182924384-502',
...
const IDENTITY_TIMELINE = {
  'MSOL_AzureSync@missionnextlabs.example': [
    { kind:'alert', time:'2026-06-28T03:45:00Z', alertId:'A105',
      ...
      description:'Directory replication initiated by MSOL_AzureSync from AAD-CONNECT-01.missionnextlabs.example targeting DC01.',
    ...
    { kind:'event', time:'2026-06-28T03:44:55Z', actionType:'DirectoryServicesReplication',
      ...
      sourceHost:'AAD-CONNECT-01', target:'DC01.missionnextlabs.example', techniqueId:'T1003', techniqueName:'OS Credential Dumping' },
    { kind:'event', time:'2026-06-28T03:44:50Z', actionType:'LogonSuccess',
      ...
      sourceHost:'AAD-CONNECT-01', target:'DC01.missionnextlabs.example', techniqueId:'T1078', techniqueName:'Valid Accounts' },
  ],
  'svc-backup@missionnextlabs.example': [
    ...
    { kind:'event', time:'2026-06-28T03:44:00Z', actionType:'DirectoryServicesReplication',
      ...
      sourceHost:'10.20.4.55', target:'DC01.missionnextlabs.example', techniqueId:'T1003', techniqueName:'OS Credential Dumping' },
  ],
  'jane.doe@missionnextlabs.example': [
  ...
  'maria.ross@missionnextlabs.example': [
  ...
  'sam.lee@missionnextlabs.example': [
  ...
  'fin-svc@missionnextlabs.example': [
...
const MC_CONNECTORS = [
  {
    id: '/subscriptions/8a41c7d2-5e93-4b16-9f70-2c6d05ea38b1/resourceGroups/rg-security-prod/providers/Cloud.Security/securityConnectors/missionnextlabs-aws-prod',
    name: 'missionnextlabs-aws-prod',
    cloud: 'AWS',
    accountId: '481512376904',
    accountAlias: 'missionnextlabs-production',
  ...
  {
    id: '/subscriptions/8a41c7d2-5e93-4b16-9f70-2c6d05ea38b1/resourceGroups/rg-security-prod/providers/Cloud.Security/securityConnectors/missionnextlabs-gcp-prod',
    name: 'missionnextlabs-gcp-prod',
    cloud: 'GCP',
    accountId: 'missionnextlabs-prod-4821',
    projectNumber: '638274195063',
    organizationId: '419028375162',
    scope: 'Single project',
    regions: ['us-central1', 'europe-west3'],
    authentication: 'Workload identity federation',
    principal: 'defender-cspm@missionnextlabs-prod-4821.iam.gserviceaccount.com',
    deployment: 'Cloud Shell bootstrap — workload identity pool defender-for-cloud',
    plans: ['CSPM','Containers','Databases'],
    health: 'Warning',
    healthDetail: 'Databases plan is degraded: the Cloud SQL Admin API is not enabled on missionnextlabs-prod-4821, so Cloud SQL instances in europe-west3 are not being assessed.',
...
const MC_RESOURCES = [
  {
    ...
    name: 'gke-missionnextlabs-payments-euw3',
    resourceId: 'projects/proj-aaaa1111/locations/europe-west3/clusters/gke-missionnextlabs-payments-euw3',
    region: 'europe-west3',
    riskLevel: 'High',
  ...
  },
  {
    ...
    name: 'missionnextlabs-prod-web-uc1-a3',
    resourceId: 'projects/proj-aaaa1111/zones/us-central1-a/instances/missionnextlabs-prod-web-uc1-a3',
    region: 'us-central1',
    riskLevel: 'Low',
  ...
  },
  {
    ...
    cloud: 'GCP',
    type: 'Compute instance',
    name: 'missionnextlabs-prod-batch-uc1-b7',
    resourceId: 'projects/proj-aaaa1111/zones/us-central1-b/instances/missionnextlabs-prod-batch-uc1-b7',
    region: 'us-central1',
    riskLevel: 'None',
  ...
  },
  {
    ...
    name: 'missionnextlabs-prod-users-sql',
    resourceId: 'projects/proj-aaaa1111/instances/missionnextlabs-prod-users-sql',
    region: 'europe-west3',
    riskLevel: 'High',
  ...
  },
  {
    ...
    cloud: 'GCP',
    type: 'Compute instance',
    name: 'missionnextlabs-prod-api-uc1-a2',
    resourceId: 'projects/proj-aaaa1111/zones/us-central1-a/instances/missionnextlabs-prod-api-uc1-a2',
    region: 'us-central1',
    riskLevel: 'Low',
  ...
  },
  {
    ...
    cloud: 'GCP',
    type: 'Storage bucket',
    name: 'missionnextlabs-prod-datalake-uc1',
    resourceId: 'projects/_/buckets/missionnextlabs-prod-datalake-uc1',
    region: 'us-central1',
    riskLevel: 'None',
  ...
  },
  {
    ...
    cloud: 'GCP',
    type: 'Container cluster',
    name: 'gke-missionnextlabs-prod-euw3',
    resourceId: 'projects/proj-aaaa1111/locations/europe-west3/clusters/gke-missionnextlabs-prod-euw3',
    region: 'europe-west3',
    riskLevel: 'Medium',
  ...
  },
  {
    ...
    cloud: 'AWS',
    type: 'S3 bucket',
    name: 'missionnextlabs-prod-artifacts-euw1',
    resourceId: 'arn:aws:s3:::missionnextlabs-prod-artifacts-euw1',
    region: 'eu-west-1',
    riskLevel: 'Low',
  ...
  },
  {
    ...
    cloud: 'AWS',
    type: 'S3 bucket',
    name: 'missionnextlabs-prod-backups-use1',
    resourceId: 'arn:aws:s3:::missionnextlabs-prod-backups-use1',
    region: 'us-east-1',
    riskLevel: 'Low',
...
const MC_ALERTS = [
  {
    ...
    severity: 'High',
    resource: 'gke-missionnextlabs-prod-euw3',
    ...
    entities: [
      { type: 'Container cluster', value: 'gke-missionnextlabs-prod-euw3' },
...
const AUDIT_LOG = [
  { time:'2026-06-28T15:00:11Z', user:'jdoe@missionnextlabs.example', op:'FileDownloaded',
    workload:'OneDrive', item:'/personal/jdoe/customer-list.xlsx', ip:'76.21.55.4' },
  { time:'2026-06-28T14:55:02Z', user:'admin@missionnextlabs.example', op:'Add member to role',
    workload:'AzureAD', item:'Role: Global Administrator', ip:'10.10.0.5' },
  { time:'2026-06-28T14:20:33Z', user:'svc-backup@missionnextlabs.example', op:'DirectoryServicesReplication',
    workload:'AAD Connect', item:'DC01.missionnextlabs.example', ip:'10.20.4.55' },
  { time:'2026-06-28T08:23:11Z', user:'jane.doe@missionnextlabs.example', op:'Consent to application',
    workload:'AzureAD', item:'DocViewer Pro', ip:'76.21.55.4' },
  { time:'2026-06-28T13:27:00Z', user:'sam.lee@missionnextlabs.example', op:'UserLoggedIn',
    workload:'AzureAD', item:'Risky sign-in', ip:'91.219.236.54' },
  { time:'2026-06-28T10:19:45Z', user:'fin-svc@missionnextlabs.example', op:'FileModified',
    workload:'SharePoint', item:'/sites/finance/budget.locked', ip:'10.30.8.22' },
  { time:'2026-07-04T09:35:00Z', user:'m.okafor@missionnextlabs.example', op:'CopilotInteraction',
    workload:'SecurityCopilot', item:'Reviewed DLP policy settings for new users.', ip:'10.10.0.8' },
  { time:'2026-07-05T13:25:00Z', user:'r.vance@missionnextlabs.example', op:'CopilotInteraction',
    workload:'SecurityCopilot', item:'Set up audit trails for all Office 365 tenants.', ip:'10.10.0.8' },
  { time:'2026-07-06T10:45:00Z', user:'m.okafor@missionnextlabs.example', op:'CopilotInteraction',
    workload:'Word', item:'Saved final draft for board presentation on OneDrive.', ip:'10.10.0.9' },
  { time:'2026-06-30T11:45:00Z', user:'r.vance@missionnextlabs.example', op:'CopilotInteraction',
    workload:'Teams', item:'Integrated Office 365 DLP policies with compliance features.', ip:'10.10.0.8' },
  { time:'2026-07-01T08:00:00Z', user:'m.okafor@missionnextlabs.example', op:'CopilotInteraction',
...
const ENTRA_TENANT = {
  name:'Mission Next Labs',
  domain:'missionnextlabs.example',
  ...
  syncStatus:'Healthy',
  syncServer:'AAD-CONNECT-01.missionnextlabs.example',
...
const ENTRA_USERS = [
  { upn:'jane.doe@missionnextlabs.example', displayName:'Jane Doe', jobTitle:'Senior Analyst', department:'Finance',
    ...
    xdrIdentity:'jane.doe@missionnextlabs.example', incidentId:'INC-1042' },
  { upn:'maria.ross@missionnextlabs.example', displayName:'Maria Ross', jobTitle:'Account Executive', department:'Sales',
    ...
    xdrIdentity:'maria.ross@missionnextlabs.example', incidentId:'INC-1051' },
  { upn:'sam.lee@missionnextlabs.example', displayName:'Sam Lee', jobTitle:'Software Engineer', department:'Engineering',
    ...
    xdrIdentity:'sam.lee@missionnextlabs.example', incidentId:'INC-1053' },
  { upn:'liam.chen@missionnextlabs.example', displayName:'Liam Chen', jobTitle:'Field Technician', department:'IT Operations',
  ...
  { upn:'nina.patel@missionnextlabs.example', displayName:'Nina Patel', jobTitle:'Billing Specialist', department:'Finance',
  ...
  { upn:'evan.brooks@missionnextlabs.example', displayName:'Evan Brooks', jobTitle:'HR Generalist', department:'Human Resources',
  ...
  { upn:'olivia.kim@missionnextlabs.example', displayName:'Olivia Kim', jobTitle:'Security Operations Lead', department:'Security Operations',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'jordan.wong@missionnextlabs.example', displayName:'Jordan Wong', jobTitle:'Travel Coordinator', department:'Operations',
    ...
    riskState:'At risk', riskLevel:'Low', riskDetail:'Consented to the Mission Next Travel enterprise app (verified publisher)',
    roles:[], licenses:['365 E3'], devices:1, groups:2,
    xdrIdentity:null, incidentId:null },
  { upn:'jdoe@missionnextlabs.example', displayName:'jdoe (local)', jobTitle:'Workstation user (WKS-03)', department:'Sales',
    ...
    roles:[], licenses:['365 E3'], devices:1, groups:2,
    xdrIdentity:'jdoe@missionnextlabs.example', incidentId:'INC-1038' },
  { upn:'dpatel@missionnextlabs.example', displayName:'Dev Patel', jobTitle:'Platform Engineer', department:'Engineering',
    ...
    roles:[], licenses:['365 E5'], devices:2, groups:5,
    xdrIdentity:null, incidentId:null },
  { upn:'mfoster@missionnextlabs.example', displayName:'Morgan Foster', jobTitle:'Manufacturing Supervisor', department:'Operations',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'olivia.martin@missionnextlabs.example', displayName:'Olivia Martin', jobTitle:'Regional Sales Manager', department:'Sales',
    ...
    roles:[], licenses:['365 E5'], devices:1, groups:4,
    xdrIdentity:null, incidentId:null },
  { upn:'m.okafor@missionnextlabs.example', displayName:'Michael Okafor', jobTitle:'Threat Analyst', department:'Security Operations',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'r.vance@missionnextlabs.example', displayName:'Rachel Vance', jobTitle:'SOC Manager', department:'Security Operations',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'tchen@missionnextlabs.example', displayName:'Tara Chen', jobTitle:'Corporate Counsel', department:'Legal',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'mrivera@missionnextlabs.example', displayName:'Marco Rivera', jobTitle:'Marketing Manager', department:'Marketing',
    ...
    roles:[], licenses:['365 E3'], devices:1, groups:2,
    xdrIdentity:null, incidentId:null },
  { upn:'j.reyes@missionnextlabs.example', displayName:'Jordan Reyes', jobTitle:'Controller', department:'Finance',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'lee.helpdesk@missionnextlabs.example', displayName:'Helpdesk (Lee)', jobTitle:'Service Desk Technician', department:'IT Operations',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'admin.tier0@missionnextlabs.example', displayName:'Tier-0 Admin', jobTitle:'Enterprise Administrator', department:'IT Operations',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'cloudadmin@missionnextlabs.example', displayName:'Cloud Admin', jobTitle:'Cloud Platform Administrator', department:'IT Operations',
    userType:'Member', enabled:true, source:'Cloud only', created:'2023-08-01T00:00:00Z',
    lastSignIn:'2026-06-28T11:47:00Z', mfa:'Authenticator', sspr:true,
    riskState:'None', riskLevel:'None', riskDetail:'',
    roles:['Global Administrator'], licenses:['365 E5'], devices:1, groups:6,
    xdrIdentity:null, incidentId:null },
  { upn:'svc-backup@missionnextlabs.example', displayName:'svc-backup', jobTitle:'Backup service account', department:'IT Operations',
    ...
    xdrIdentity:'svc-backup@missionnextlabs.example', incidentId:'INC-1019' },
  { upn:'fin-svc@missionnextlabs.example', displayName:'fin-svc', jobTitle:'Finance file-server service account', department:'Finance',
    ...
    xdrIdentity:'fin-svc@missionnextlabs.example', incidentId:'INC-1050' },
  { upn:'MSOL_AzureSync@missionnextlabs.example', displayName:'MSOL_AzureSync', jobTitle:'Directory synchronization (Entra Connect)', department:'Entra Connect',
    ...
    xdrIdentity:'MSOL_AzureSync@missionnextlabs.example', incidentId:'INC-1019' },
  { upn:'svc-scan@missionnextlabs.example', displayName:'svc-scan', jobTitle:'Vulnerability scanner service account', department:'Security Operations',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'legacy.batch@missionnextlabs.example', displayName:'legacy-batch', jobTitle:'Nightly batch job', department:'Finance',
    ...
    xdrIdentity:null, incidentId:null },
  { upn:'krbtgt@missionnextlabs.example', displayName:'krbtgt', jobTitle:'KDC service account', department:'Active Directory',
    ...
    xdrIdentity:'krbtgt@missionnextlabs.example', incidentId:'INC-1019' },
  { upn:'partner.auditor@fabrikam.com', displayName:'Priya Raman (Fabrikam)', jobTitle:'External auditor', department:'—',
    ...
    roles:[], licenses:[], devices:0, groups:1,
    xdrIdentity:null, incidentId:null },
  { upn:'svc-partner@missionnextlabs.example', displayName:'svc-partner', jobTitle:'Partner data feed', department:'Sales',
...
const ENTRA_ROLE_ASSIGNMENTS = [
  { role:'Global Administrator',        active:2, eligible:0, members:['admin.tier0@missionnextlabs.example','cloudadmin@missionnextlabs.example'],
    note:'Two permanent assignments — Product guidance recommends 2–4 with phishing-resistant MFA.' },
  { role:'Security Administrator',      active:0, eligible:2, members:['olivia.kim@missionnextlabs.example','r.vance@missionnextlabs.example'],
    note:'PIM eligible only. Olivia Kim activated for 45 minutes under CHG-4821.' },
  { role:'Security Operator',           active:1, eligible:0, members:['r.vance@missionnextlabs.example'],
    note:'Standing assignment used for Defender XDR response actions.' },
  { role:'Security Reader',             active:1, eligible:0, members:['m.okafor@missionnextlabs.example'],
    note:'Read-only analyst access across Defender and Sentinel.' },
  { role:'Helpdesk Administrator',      active:1, eligible:0, members:['lee.helpdesk@missionnextlabs.example'],
    note:'Can reset passwords for non-admin users — a common attacker target.' },
  { role:'eDiscovery Manager',          active:1, eligible:0, members:['tchen@missionnextlabs.example'],
    note:'Purview eDiscovery (Premium) case owner.' },
  { role:'Directory Synchronization Accounts', active:1, eligible:0, members:['MSOL_AzureSync@missionnextlabs.example'],
...
const ENTRA_RECENT_SIGNINS = [
  { time:'2026-06-28T13:33:00Z', user:'sam.lee@missionnextlabs.example',    app:'Azure Portal',                 ip:'91.219.236.54',  location:'Amsterdam, NL', result:'Blocked by CA', risk:'High',   ca:'CA003 - Risky sign-in MFA' },
  { time:'2026-06-28T13:27:00Z', user:'sam.lee@missionnextlabs.example',    app:'Exchange Online',              ip:'91.219.236.54',  location:'Amsterdam, NL', result:'Success',       risk:'High',   ca:'Not applied' },
  { time:'2026-06-28T10:20:00Z', user:'fin-svc@missionnextlabs.example',    app:'Windows SMB (on-prem)',        ip:'10.20.4.55',     location:'Redmond, US',   result:'Success',       risk:'High',   ca:'Not applied' },
  { time:'2026-06-28T09:05:00Z', user:'jordan.wong@missionnextlabs.example',  app:'Mission Next Travel',               ip:'76.21.55.4',     location:'Seattle, US',   result:'Success',       risk:'Low',    ca:'CA001 satisfied' },
  { time:'2026-06-28T08:30:00Z', user:'jane.doe@missionnextlabs.example',   app:'DocViewer Pro',                ip:'185.199.111.12', location:'Ashburn, US',   result:'Success',       risk:'High',   ca:'Not applied' },
  { time:'2026-06-28T06:44:00Z', user:'maria.ross@missionnextlabs.example', app:'SharePoint Online',            ip:'185.199.111.12', location:'Ashburn, US',   result:'Interrupted',   risk:'High',   ca:'CA003 - Risky sign-in MFA' },
...
// refer to the same fictional Mission Next Labs principals.
const M365_ADMIN_TENANT = {
  name:'Mission Next Labs', domain:'missionnextlabs.example', view:'Dashboard view',
...
const M365_MESSAGE_CENTER = [
  {
    ...
    whatWhy:'Mission Next Labs should review users who have not registered a strong authentication method before the next registration campaign.',
