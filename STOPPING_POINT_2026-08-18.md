...
Repo: `~/Mission_Next_Technical_Academy_SOC_Analyst_course`
Branch: `master`
Base commit: `873df15`
...
- Removed the floating Mission Next “M” launcher from the simulator.
...
| User | User column | `j.santos@missionnextlabs.example` |
