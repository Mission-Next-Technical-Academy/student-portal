...
(function () {
  ...
  function normalizePath(p) {
    return window.B2B_VFS && window.B2B_VFS.normalize ? window.B2B_VFS.normalize(p) : p;
  }
  ...
  function cmd_dpkg(env, args) {
    ...
    const statusPath = '/var/lib/dpkg/boots2bytes-installed.txt';
  ...
  Object.assign(window, { B2B_BASH_ENGINE: { runLine, tokenize, splitPipes, BUILTINS } });
  ...
  function LinuxTerminalShell(props) {
    ...
    function runUserLine(line) {
      ...
      const result = window.B2B_BASH_ENGINE.runLine(env, line);
