...
function getEnterpriseLabType(mod, track) {
  ...
  if (id === 'lab-lap-3') return 'event-viewer';
  if (id === 'lab-lap-5') return 'sysmon-viewer';
  if (id === 'lab-wf-2') return 'registry-editor';
  if (id.startsWith('lab-ma-')) return 'malware-analysis';
  if (id.startsWith('lab-ad-')) return 'active-directory';
  if (id === 'lab-sa-3') return 'burp-proxy';
  if (id === 'lab-sa-5') return 'iam-matrix';
  if (id.startsWith('lab-sa-')) return 'linux-terminal';
  if (id === 'lab-vm-1') return 'openvas';
  if (id === 'lab-vm-2') return 'nessus';
  if (id === 'lab-vm-3') return 'qualys';
  if (id === 'lab-vm-4') return 'zap';
  if (id === 'lab-vm-5') return 'wsus';
  return null;
}
