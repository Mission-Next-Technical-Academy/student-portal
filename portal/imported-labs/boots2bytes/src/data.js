// ============================================================
//  Boots2Bytes — SOC Analyst Track  |  Data Layer
// ============================================================
...
const ACTIVE_DIRECTORY_PROJECTS = [
  ...
  { id:'ad-2', title:'Active Directory Logs and Insights with Splunk', focus:'Splunk', difficulty:'Beginner', estimatedTime:'55 min', summary:'Use Splunk-style analysis to inspect Active Directory logs and security-relevant patterns.', skills:['Splunk','AD logs','Search'], url:'https://github.com/0xrajneesh/Active-Directory-Monitoring-Projects/blob/main/project-2-active-directory-monitoring-with-splunk.md' },
...
function getProgress() {
  try { return JSON.parse(localStorage.getItem('b2b_progress') || '{}'); } catch { return {}; }
}
function saveProgress(p) { localStorage.setItem('b2b_progress', JSON.stringify(p)); }
...
function getSession() { try { return JSON.parse(localStorage.getItem('b2b_session')); } catch { return null; } }
function setSession(u) { localStorage.setItem('b2b_session', JSON.stringify(u)); }
function clearSession() { localStorage.removeItem('b2b_session'); }
