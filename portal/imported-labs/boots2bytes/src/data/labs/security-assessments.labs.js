...
(function () {
  ...
  const SA5_LAB = {
    ...
    scenario: {
      role: 'IAM analyst on the quarterly account-review rotation',
      incident: 'You are doing a quarterly user-account review on corp.example.local. HR flagged that no users on the contractor roster should still have wheel/sudo membership. Identify the contractor account that retains privileged group membership, and review the supporting telemetry.',
    },
        ...
        steps: [
          {
            ...
            kind: 'command',
            instruction: 'Install the PAM development headers (we will configure pam_tally2 next).',
          ...
          },
          {
            ...
            kind: 'command',
            instruction: 'Read the current /etc/pam.d/common-auth to see whether a pam_tally2 lockout is already in place.',
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            kind: 'analyze',
            instruction: 'Run chkpasswd. Which two service accounts come back as WEAK? Submit either one of the usernames.',
          ...
          },
          {
            ...
            kind: 'command',
            instruction: 'Read /etc/login.defs to inspect the policy.',
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            kind: 'analyze',
            instruction: 'Look at the sudoers file. Which user has NOPASSWD: ALL — the most dangerous unconditional escalation?',
          ...
          },
          {
            ...
            instruction: 'Switch to the IAM Matrix (left). Toggle "Show admin members". Click temp.contractor and confirm wheel membership ⚠.',
        ...
        steps: [
          {
            ...
            kind: 'command',
            instruction: '(Practice) Add a hypothetical groupname to a hypothetical user. Use `usermod -aG developers j.sanders`.',
          ...
          },
          {
            ...
            kind: 'command',
            instruction: 'Now remediate: remove temp.contractor from the wheel group.',
          ...
          },
          {
            ...
            kind: 'command',
            instruction: 'Verify temp.contractor\'s remaining group memberships.',
        ...
        steps: [
          {
            ...
            kind: 'analyze',
            instruction: 'Run faillog. How many failed attempts does it report for temp.contractor?',
          ...
          },
          {
            ...
            kind: 'command',
            instruction: 'Reset the failed login counter for temp.contractor (housekeeping after the review).',
          ...
          },
          {
            ...
            kind: 'command',
            instruction: 'Review /etc/login.defs to confirm FAILLOG_ENAB is set.',
            hint: '`cat /etc/login.defs`',
            acceptedInputs: [{ type: 'regex', value: /^(less|cat|nano)\s+\/etc\/login\.defs\s*$/ }],
            validation: { type: 'commandExecuted' },
            points: 5,
