...
(function () {
  ...
  function buildLap1Fs() {
    return {
      ...
      'var': {
        ...
        'www': {
          'html': {
            'index.html':      '<html><body>Welcome to Mission Next Web</body></html>\n',
          },
        },
      },
      'etc': {
  ...
  function buildLap2RsyslogConf() {
    return [
      '# /etc/rsyslog.conf - Mission Next synthetic training config',
  ...
  // lap-3 and lap-5 keep their gold-shell labs from data.js / lab-shells.jsx; do NOT shadow them in MISSION_NEXT_LABS.
  ...
  Object.assign(window, { MISSION_NEXT_LAP_1: LAP_1_LAB, MISSION_NEXT_LAP_2: LAP_2_LAB, MISSION_NEXT_LAP_4: LAP_4_LAB });
})();
