...
function moduleTwelvePreparation() {
  return `<details class="m12-section-collapsible"><summary><div class="m12-section-heading"><span><i class="ri-book-open-line" aria-hidden="true"></i></span><div><p class="m12-kicker">Capstone preparation lectures</p><h2 id="m12-preparation-title">Briefing before the independent range</h2></div></div></summary><section class="m12-section" id="m12-preparation" aria-labelledby="m12-preparation-title">
...
function viewModuleTwelve(user, program) {
  ...
  return `<div class="m12-shell">${moduleTwelveHeader(user, program)}${moduleUnifiedNav(sections, { moduleKey: 'm12' })}<div class="mquick-nav-layout"><main class="m12-main">
    ...
    <details class="m12-section-collapsible" open><summary><div class="m12-section-heading"><span><i class="ri-route-line" aria-hidden="true"></i></span><div><p class="m12-kicker">Mission requirements</p><h2 id="m12-mission-title">Outcomes, not a prescribed attack path</h2></div></div></summary><section class="m12-section"><p class="m12-muted">The twelve requirements may be completed in any order. They describe the deliverable, not the attacker's sequence; discover chronology from the evidence. Amber Finch is the capstone composite: Cedar Lock (M09–M11) rehearsed the response, custody, and reporting handoffs, while this case asks you to integrate those decisions with the earlier identity, SIEM, detection, endpoint, hunting, network, and prioritization work.</p>${moduleTwelveMissionStatus()}</section></details>
    <details class="m12-section-collapsible"><summary><div class="m12-section-heading"><span><i class="ri-dashboard-3-line" aria-hidden="true"></i></span><div><p class="m12-kicker">Complete integrated range</p><h2 id="m12-range-title">Investigation consoles</h2></div></div></summary><section class="m12-section m12-range-section" id="m12-range"><div id="m12-console-root">${moduleTwelveConsole()}</div>${moduleTwelveEvidenceTray()}</section></details>
    <details class="m12-section-collapsible"><summary><div class="m12-section-heading"><span><i class="ri-file-edit-line" aria-hidden="true"></i></span><div><p class="m12-kicker">Prove It</p><h2>Capstone assessment</h2></div></div></summary><section class="m12-section m12-assessment-section" id="m12-assessment-section">${moduleTwelveAssessment()}</section></details>
  </main></div></div>`;
}
