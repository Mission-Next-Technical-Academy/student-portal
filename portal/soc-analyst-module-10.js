...
const MODULE_TEN_RETURN_TO = missionNextReturnTo(10);

function moduleTenGuidedLabPanel() {
  const links = [
    { label: 'Analyzing Windows Registry for Evidence of Malicious Activity', href: `imported-labs/mission-next-labs/index.html?returnTo=${MODULE_TEN_RETURN_TO}#/track/windows-forensics/project/wf-2/lab` },
