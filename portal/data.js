...
const LABS = [
  ...
  itsLab({ key: 'lab-its-11-handoff-documentation', module: 'its-11', title: 'Writing the Handoff That Actually Helps', difficulty: 'Foundational', minutes: 75,
    parentAllocations: [allocation('ITHD-101.2', 75)], objective: 'Recognize an escalation trigger and write a complete, stranger-actionable handoff note.',
    description: 'A coach-guided walkthrough of ticket HD-2113 (expired VPN gateway certificate) in the IT Service Desk simulator, focused on documentation and escalation.',
