...
const LABS = [
  ...
  itsLab({ key: 'lab-its-01-ticket-triage', module: 'its-01', title: 'A Day in the Life of an L1 Technician', difficulty: 'Foundational', minutes: 30,
    parentAllocations: [allocation('ITHD-101.1', 30)], objective: 'Categorize five realistic tickets, state a first diagnostic step for each, and make a supported resolve-or-escalate call.',
    description: 'Work a five-ticket simulated queue spanning endpoint, identity, network, hardware, and server categories, applying the five-step troubleshooting mindset.',
  ...
  itsLab({ key: 'lab-its-02-device-manager', module: 'its-02', title: 'The Misbehaving Peripheral', difficulty: 'Foundational', minutes: 30,
    parentAllocations: [allocation('ITHD-101.4', 30)], objective: 'Diagnose a device error in Device Manager and apply the correct driver fix rather than the first available option.',
    description: 'Simulated Device Manager lab: diagnose a webcam Code 43 error, roll back the correct driver, verify the fix, and document it.',
    skills: ['Device Manager', 'Driver Troubleshooting'], portalEntry: '#/program/it-support/module/2' }),
  itsLab({ key: 'lab-its-02-print-spooler', module: 'its-02', title: 'The Stuck Queue and the Offline Printer', difficulty: 'Foundational', minutes: 30,
    parentAllocations: [allocation('ITHD-101.4', 30)], objective: 'Resolve a stuck print queue and an offline printer flag in the correct order and verify the fix.',
    description: 'Simulated print-queue and Print Spooler lab: clear a stuck job, restart the spooler, fix an offline flag, and verify with a test print, in the correct order.',
    skills: ['Print Spooler', 'Printer Triage'], portalEntry: '#/program/it-support/module/2' }),
