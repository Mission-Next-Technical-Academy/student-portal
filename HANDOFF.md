...
`mnt-portal.lab-state.v1.m02-trust-path-review-v1.student-<anonymous hash>`

For the `user2` fixture the resolved key is
`mnt-portal.lab-state.v1.m02-trust-path-review-v1.student-86bdca71`. The two-step
...
`mnt-portal.lab-state.v1.m03-siem-signal-room-v1.<anonymous-student-id>`; the
