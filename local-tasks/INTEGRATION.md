...
Last run: 2026-07-06T11:20:10+02:00 (rewritten every `integrate.py` run — do not hand-edit).
...
the consts directly: `COPILOT_SESSIONS`, `COPILOT_TRANSCRIPTS`, `COPILOT_PROMPTBOOKS`, `COPILOT_PLUGINS`, `COPILOT_USAGE`, `COPILOT_CAPACITY`, `TVM_SOFTWARE`, `TVM_CVES`, `TVM_RECOMMENDATIONS`, `MC_CONNECTORS`, `MC_RESOURCES`, `MC_ALERTS`, `AUDIT_RETENTION_POLICIES`, `AUDIT_COPILOT_EVENTS`, `TX_EMAILS`, `MSSP_TENANTS`, `MTO_INCIDENTS`.
